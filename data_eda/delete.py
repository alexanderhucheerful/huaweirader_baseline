...
if __name__ == '__main__':
    txtpath = r'C:\Users\office\Desktop/Testmiss'
    ...
    for a, b ,d in trainloader:
        ...
        for i in range(0, 21):
            ...
            if a[0, i].mean() == 0:
                ...
                #if (i==0 or i==2 or i==4 or i==6 or i==8 or i==10 or i==11 or i==12 or i==13 or i==15 or i==17 or i==19 or i==14 or i==16 or i==18 or i==20 or i==25 or i==30 or i==35 or i==40):
                ...
                pic=np.array(Image.open(b[0]+"/"+d[0]+"_"+str(i).zfill(3)+".png"))

                if i==0:
                    pic=np.array(Image.open(b[0]+"/"+d[0]+"_"+str(i+1).zfill(3)+".png"))
                    ...
                    if a[0, i+1].mean() == 0:
                        ...
                        pic = (np.array(Image.open(b[0] + "/" + d[0] + "_" + str(i - 1).zfill(3) + ".png"))+np.array(Image.open(b[0]+"/"+d[0]+"_"+str(i+1).zfill(3)+".png")))/2
                pic=Image.fromarray(pic).convert("L")
                # plt.imshow(pic)
                os.remove(b[0] + "/" + d[0] + "_" + str(i).zfill(3) + ".png")
                pic.save(b[0]+"/"+d[0]+"_"+str(i).zfill(3)+".png")
                #plt.imsave(r"C:\Users\office\Desktop/Testmiss"+"/"+d[0]+"_"+str(i).zfill(3)+".png",pic)
                # pic1=Image.open(b[0]+"/"+d[0]+"_"+str(i-1).zfill(3)+".png")
                # plt.imshow(pic1)
                # pic2=Image.open(b[0]+"/"+d[0]+"_"+str(i+1).zfill(3)+".png")
                # plt.imshow(pic2)
