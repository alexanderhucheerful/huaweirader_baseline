...
if os.path.exists(os.path.join(save_dir, 'predrnncheckpoint.pth.tar')) and False:
    # load existing model
    print('==> loading existing model')
    model_info = torch.load(os.path.join(save_dir, 'predrnncheckpoint.pth.tar'))
...
###############################################tenosrboard太麻烦######
            ...
            plt.savefig('/media/workdir/hujh/hujh-new/huaweirader_baseline/log/demolog/predrnnloss.png')
            plt.close(1)
#################################################################################
            #changepoint
            if ind %100 ==0:
...
################# valid ########################################################
    ...
    if False :
        ...
        plt.legend()
        #changepoint
        plt.savefig('/media/workdir/hujh/hujh-new/huaweirader_baseline/log/demolog/predrnnval.png')
        plt.close(2)
